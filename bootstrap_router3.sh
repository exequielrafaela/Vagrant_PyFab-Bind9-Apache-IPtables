...
#vagrant@router3:~$ ip route 
#default via 192.168.2.1 dev eth1 
#10.0.2.0/24 dev eth0  proto kernel  scope link  src 10.0.2.15 
#172.16.0.0/24 dev eth2  proto kernel  scope link  src 172.16.0.254 
#172.16.1.0/24 via 192.168.2.1 dev eth1 
#172.16.2.0/24 via 192.168.2.1 dev eth1 
#192.168.0.0/24 via 192.168.2.1 dev eth1 
#192.168.1.0/30 via 192.168.2.1 dev eth1 
