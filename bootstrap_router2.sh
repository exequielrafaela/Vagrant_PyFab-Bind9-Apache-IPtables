...
sudo ip addr add 20.0.0.2/30 dev eth2
sudo ip link set eth3 up
sudo ip addr add 30.0.0.1/30 dev eth3
sudo echo 1 >> /proc/sys/net/ipv4/ip_forward
sudo service ufw stop
sudo service apparmor teardown
sudo ip route add 192.168.1.0/24 via 20.0.0.1
sudo ip route add 172.16.0.0/24 via 30.0.0.2
